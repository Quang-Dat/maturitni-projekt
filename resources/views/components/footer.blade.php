<footer class="mt-20 pt-20 flex flex-col items-center bg-hneda text-bila">
    <div class="flex flex-col md:flex-row items-center justify-around md:items-start w-full border-b-bila border-b-4 pb-20">
        <div class="flex flex-col items-start w-[275px] md:w-max my-5 md:my-0">
            <h3 class="text-2xl font-extrabold mb-2">Odkazy</h3>
            <a class="" href="">Jídelní lístek</a>
            <a class="" href="">Nápojový lístek</a>
            <a class="" href="">O nás</a>
            <a class="" href="">Kontakty</a>
            <a class="" href="">Recenze</a>
        </div>

        <div class="flex flex-col items-start w-[275px] md:w-max my-5 md:my-0">
            <h3 class="text-2xl font-extrabold mb-2">Kontakty</h3>
        ...
        <div class="flex flex-col items-start w-[275px] md:w-max my-5 md:my-0">
            <h3 class="text-2xl font-extrabold mb-2">Sociální sítě</h3>
